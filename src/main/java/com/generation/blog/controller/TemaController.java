...
public class TemaController {
	...
	@GetMapping("/descricao/{descricao}") // "descricao"
	...
	@PutMapping              // put é o nome da função
	...
	public void delete(@PathVariable Long id) {
		Optional <Tema> tema = temaRepository.findById(id); // opção: se existir, boa. Senão, boa tb.
